    ...
    <SafeAreaView>
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>챌린지 생성</Text>
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>기간을 입력하세요</Text>
          <TextInput
            style={styles.input}
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>인증 방식을 선택하세요.</Text>
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>인원을 입력하세요.</Text>
          <TextInput style={styles.input} value="10" />
        </View>

        <View style={styles.inputGroup}>
          <Text style={styles.label}>참가비를 입력하세요.</Text>
          <TextInput style={styles.input} value="20000원" />
        </View>
        <Text style={styles.label}>챌린지 세부 설명을 입력하세요.</Text>
        <TextInput
        ...
        <Text style={styles.label}>챌린지 규칙을 정하세요.</Text>
